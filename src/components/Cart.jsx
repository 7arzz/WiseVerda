...
const Cart = () => {
  const { cart, removeFromCart, totalPrice, isCartOpen, setIsCartOpen } =
          ...
          >
            ...
            >
              <h2 style={{ fontSize: "28px", margin: 0, color: "white" }}>
                System <span style={{ color: "var(--primary)" }}>Cart</span>
              </h2>
              <motion.button
            ...
            <div
              style={{ flexGrow: 1, overflowY: "auto", marginBottom: "40px" }}
            >
              {cart.length === 0 ? (
                <div
                  style={{
