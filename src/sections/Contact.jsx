        ...
        >
          ...
          <div style={{ position: 'relative', zIndex: 1 }}>
            <span style={{ 
              ...
              display: 'block',
              marginBottom: '16px'
            }}>{contactData.badge}</span>
            <h2 style={{ marginBottom: '20px', color: 'white' }}>{contactData.title.split('Upgrade')[0]}<span className="text-gradient">Upgrade</span> Your Business?</h2>
            <p style={{ color: 'rgba(255,255,255,0.6)', marginBottom: '56px', fontSize: '20px', maxWidth: '600px', margin: '0 auto 56px' }}>
            ...
            <div className="contact-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '40px', marginBottom: '64px' }}>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                ...
                <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)' }}>{contactData.email}</p>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                <div style={{ padding: '16px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', color: 'var(--accent)' }}>
                  <MapPinIcon size={28} />
                </div>
                <h4 style={{ fontSize: '18px', color: 'white' }}>Location</h4>
                <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)' }}>{contactData.location}</p>
              </div>
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px' }}>
                <div style={{ padding: '16px', background: 'rgba(255,255,255,0.05)', borderRadius: '16px', color: 'var(--primary)' }}>
                ...
                <p style={{ fontSize: '15px', color: 'rgba(255,255,255,0.5)' }}>{contactData.liveChat}</p>
              </div>
            </div>
            ...
            <motion.button 
              ...
              style={{ padding: '20px 60px', fontSize: '18px', boxShadow: '0 20px 40px var(--primary-glow)' }}
            >
